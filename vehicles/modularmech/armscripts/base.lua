...
local PLUGIN_PATH = "/vehicles/modularmech/armscripts/base_plugins.config"
...
MechArm.new =
  PluginLoader.add_plugin_loader("armscripts/base", PLUGIN_PATH, MechArm.new)
...
function MechArm:updateBase(dt, driverId, isFiring, wasFiring, aimPosition, facingDirection)
