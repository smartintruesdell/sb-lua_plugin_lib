...
local PLUGINS_PATH = "/vehicles/modularmech/armscripts/beamarm_plugins.config"
...
BeamArm.init = PluginLoader.add_plugin_loader("beamarm", PLUGINS_PATH, BeamArm.init)
