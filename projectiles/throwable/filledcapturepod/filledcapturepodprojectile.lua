...
local PLUGINS_PATH =
  "/projectiles/throwable/filledcapturepod/filledcapturepodprojectile_plugins.config"
...
init = PluginLoader.add_plugin_loader("filledcapturepodprojectile", PLUGINS_PATH, init)
