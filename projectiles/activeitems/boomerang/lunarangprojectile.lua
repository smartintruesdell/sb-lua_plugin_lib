...
local PLUGINS_PATH =
  "/projectiles/activeitems/boomerang/lunarangprojectile_plugins.config"
...
boomerangExtra.init = PluginLoader.add_plugin_loader("lunarangprojectile", PLUGINS_PATH, boomerangExtra.init)
