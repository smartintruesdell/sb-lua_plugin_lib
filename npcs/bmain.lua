...
function init()
  ...
  init_set_spawn_position()
  init_set_quest_callbacks()
  init_set_behavior()
  init_set_items()
  init_set_movement_properties()
...
init = PluginLoader.add_plugin_loader("bmain", PLUGINS_PATH, init)

function init_set_spawn_position()
...
function init_set_quest_callbacks()
...
function init_set_behavior()
  ...
  if personality().behaviorConfig then
    self.behaviorConfig = applyDefaults(
      personality().behaviorConfig,
      self.behaviorConfig
    )
  end
end

function init_set_items()
...
function init_set_movement_properties()
...
function update_handle_delayed_items()
...
function update_handle_die()
  self.die =
    (self.shouldDie and not status.resourcePositive("health")) or
    self.forceDie
end
...
function interact(args)
  ...
  if self.tradingConfig ~= nil and self.tradingEnabled then
    return { "OpenMerchantInterface", interact_get_trading_config(args) }
  end
...
function interact_get_trading_config(_args)
  return self.tradingConfig
end
