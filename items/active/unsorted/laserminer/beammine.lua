...
local PLUGINS_PATH =
  "/items/active/unsorted/laserminer/beammine_plugins.config"
...
BeamMine.init = PluginLoader.add_plugin_loader("beammine", PLUGINS_PATH, BeamMine.init)
