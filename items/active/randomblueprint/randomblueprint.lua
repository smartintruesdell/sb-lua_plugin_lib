...
local PLUGINS_PATH = "/items/active/randomblueprint/randomblueprint_plugins.config"
...
init = PluginLoader.add_plugin_loader("randomblueprint", PLUGINS_PATH, init)
...
function learnBlueprint()
  ...
  while player.blueprintKnown(itemName) and math.random() > self.duplicateChance do
