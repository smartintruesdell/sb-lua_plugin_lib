...
local PLUGINS_PATH =
  "/items/active/weapons/protectorate/protectoratebroadsword/empowerment_plugins.config"
...
Empowerment.init =
  PluginLoader.add_plugin_loader("empowerment", PLUGINS_PATH, Empowerment.init)
