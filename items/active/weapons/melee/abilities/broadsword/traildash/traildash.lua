...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/broadsword/traildash/traildash_plugins.config"
...
TrailDash.init =
  PluginLoader.add_plugin_loader("traildash", PLUGINS_PATH, TrailDash.init)
