...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/broadsword/travelingslash/travelingslash_plugins.config"
...
TravelingSlash.init = PluginLoader.add_plugin_loader("travelingslash", PLUGINS_PATH, TravelingSlash.init)
