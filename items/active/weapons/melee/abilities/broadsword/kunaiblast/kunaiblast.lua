...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/broadsword/kunaiblast/kunaiblast_plugins.config"
...
KunaiBlast.init =
  PluginLoader.add_plugin_loader("kunaiblast", PLUGINS_PATH, KunaiBlast.init)
