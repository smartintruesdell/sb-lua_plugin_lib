...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/broadsword/spinslash/superspinslash_plugins.config"
...
SuperSpinSlash.init = PluginLoader.add_plugin_loader("superspinslash", PLUGINS_PATH, SuperSpinSlash.init)
