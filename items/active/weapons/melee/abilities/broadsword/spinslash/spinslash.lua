...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/broadsword/spinslash/spinslash_plugins.config"
...
SpinSlash.init = PluginLoader.add_plugin_loader("spinslash", PLUGINS_PATH, SpinSlash.init)
