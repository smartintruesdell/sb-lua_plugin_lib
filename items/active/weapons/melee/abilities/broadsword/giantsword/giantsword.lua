...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/broadsword/giantsword/giantsword_plugins.config"
...
GiantBladeAttack.init =
  PluginLoader.add_plugin_loader("giantsword", PLUGINS_PATH, GiantBladeAttack.init)
