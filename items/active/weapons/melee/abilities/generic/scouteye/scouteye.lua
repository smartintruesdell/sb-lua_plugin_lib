...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/generic/scouteye/scouteye_plugins.config"
...
ScoutEye.init = PluginLoader.add_plugin_loader("scouteye", PLUGINS_PATH, ScoutEye.init)
