...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/generic/blinkslash/blinkslash_plugins.config"
...
BlinkSlash.init =
  PluginLoader.add_plugin_loader("blinkslash", PLUGINS_PATH, BlinkSlash.init)
