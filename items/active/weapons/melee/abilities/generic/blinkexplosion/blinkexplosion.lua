...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/generic/blinkexplosion/blinkexplosion_plugins.config"
init = PluginLoader.add_plugin_loader("blinkexplosion", PLUGINS_PATH, init)
...
BlinkExplosion.init =
  PluginLoader.add_plugin_loader("blinkexplosion", PLUGINS_PATH, BlinkExplosion.init)
