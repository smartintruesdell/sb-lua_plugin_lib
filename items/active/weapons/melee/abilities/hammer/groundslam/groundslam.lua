...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/hammer/groundslam/groundslam_plugins.config"
...
GroundSlam.init =
  PluginLoader.add_plugin_loader("groundslam", PLUGINS_PATH, GroundSlam.init)
