...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/hammer/uppercut/uppercut_plugins.config"
...
UpperCut.init = PluginLoader.add_plugin_loader("uppercut", PLUGINS_PATH, UpperCut.init)
