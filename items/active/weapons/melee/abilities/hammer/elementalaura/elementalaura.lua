...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/hammer/elementalaura/elementalaura_plugins.config"
...
ElementalAura.init = PluginLoader.add_plugin_loader("elementalaura", PLUGINS_PATH, ElementalAura.init)
