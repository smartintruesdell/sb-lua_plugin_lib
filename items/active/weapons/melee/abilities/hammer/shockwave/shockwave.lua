...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/hammer/shockwave/shockwave_plugins.config"

ShockWave = WeaponAbility:new()

function ShockWave:init() end
ShockWave.init =
  PluginLoader.add_plugin_loader("shockwave", PLUGINS_PATH, ShockWave.init)
