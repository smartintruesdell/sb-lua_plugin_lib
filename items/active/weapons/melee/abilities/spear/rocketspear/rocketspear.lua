...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/spear/rocketspear/rocketspear_plugins.config"
...
RocketSpear.init =
  PluginLoader.add_plugin_loader("rocketspear", PLUGINS_PATH, RocketSpear.init)
