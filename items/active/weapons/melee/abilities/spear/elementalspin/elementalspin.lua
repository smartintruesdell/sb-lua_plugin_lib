...
local PLUGINS_PATH =
  "/items/active/weapons/melee/abilities/spear/elementalspin/elementalspin_plugins.config"
...
ElementalSpin.init =
  PluginLoader.add_plugin_loader("elementalspin", PLUGINS_PATH, ElementalSpin.init)
