...
local PLUGINS_PATH =
  "/items/active/weapons/ranged/abilities/fuelairtrail/fuelairtrail_plugins.config"
...
FuelAirTrail.init =
  PluginLoader.add_plugin_loader("fuelairtrail", PLUGINS_PATH, FuelAirTrail.init)
