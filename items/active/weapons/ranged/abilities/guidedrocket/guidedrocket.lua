...
local PLUGINS_PATH =
  "/items/active/weapons/ranged/abilities/guidedrocket/guidedrocket_plugins.config"
...
GuidedRocket.new = PluginLoader.add_plugin_loader("guidedrocket", PLUGINS_PATH, GuidedRocket.new)
