...
local PLUGINS_PATH =
  "/items/active/weapons/ranged/abilities/explosiveburst/explosiveburst_plugins.config"
...
ExplosiveBurst.init =
  PluginLoader.add_plugin_loader("explosiveburst", PLUGINS_PATH, ExplosiveBurst.init)
