...
local PLUGINS_PATH =
  "/items/active/weapons/ranged/abilities/markedshot/markedshot_plugins.config"
...
MarkedShot.new = PluginLoader.add_plugin_loader("markedshot", PLUGINS_PATH, MarkedShot.new)
