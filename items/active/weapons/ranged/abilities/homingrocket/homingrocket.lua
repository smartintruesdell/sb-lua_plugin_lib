...
local PLUGINS_PATH =
  "/items/active/weapons/ranged/abilities/homingrocket/homingrocket_plugins.config"
...
HomingRocketAttack.new =
  PluginLoader.add_plugin_loader("homingrocket", PLUGINS_PATH, HomingRocketAttack.new)
