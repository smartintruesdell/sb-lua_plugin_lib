...
local PLUGINS_PATH =
  "/items/active/weapons/ranged/abilities/chargefire/chargefire_plugins.config"
...
ChargeFire.init = PluginLoader.add_plugin_loader("chargefire", PLUGINS_PATH, ChargeFire.init)
