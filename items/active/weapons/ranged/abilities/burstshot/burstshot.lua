...
local PLUGINS_PATH =
  "/items/active/weapons/ranged/abilities/burstshot/burstshot_plugins.config"
...
BurstShot.init = PluginLoader.add_plugin_loader("burstshot", PLUGINS_PATH, BurstShot.init)
