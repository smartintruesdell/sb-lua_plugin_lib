...
local PLUGINS_PATH =
  "/items/active/weapons/other/remotegrenadelauncher/remotegrenadelauncher_plugins.config"
...
init = PluginLoader.add_plugin_loader("remotegrenadelauncher", PLUGINS_PATH, init)
