...
local PLUGINS_PATH =
  "/objects/ancient/ancientconsole/ancientconsole_plugins.config"
...
init = PluginLoader.add_plugin_loader("ancientconsole", PLUGINS_PATH, init)
...
function onInteraction()
  if self.isOutpostGate then
    ...
    if not storage.vaultActive then
      return { "ScriptPane", "/interface/scripted/vaultconsole/vaultconsolegui.config" }
    else
