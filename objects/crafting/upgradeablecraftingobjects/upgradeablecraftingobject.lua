...
local PLUGINS_PATH =
  "/objects/crafting/upgradeablecraftingobjects/upgradeablecraftingobject_plugins.config"
...
init = PluginLoader.add_plugin_loader("upgradeablecraftingobject", PLUGINS_PATH, init)
