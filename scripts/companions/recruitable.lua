...
local PLUGIN_PATH = "/scripts/companions/recruitable_plugins.config"
...
recruitable.init =
  PluginLoader.add_plugin_loader("recruitable", PLUGIN_PATH, recruitable.init)
...
function recruitable.generateRank()
  ...
  storage.recruitRank = sb.replaceTags(ranks[math.random(#ranks)], tags)
