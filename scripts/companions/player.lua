...
local PLUGIN_PATH = "/scripts/companions/player_plugins.config"
...
init = PluginLoader.add_plugin_loader("companions/player", PLUGIN_PATH, init)
...
-- See if we can add recruitUuid to our ship crew and followers lists without
