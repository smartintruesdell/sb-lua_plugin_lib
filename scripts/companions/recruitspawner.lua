...
local PLUGIN_PATH = "/scripts/companions/recruitspawner_plugins.config"
...
recruitSpawner.init =
  PluginLoader.add_plugin_loader("recruitspawner", PLUGIN_PATH, recruitSpawner.init)
...
function recruitSpawner:getShipUpgrades()
  local upgrades = {}
  self:forEachCrewMember(function (recruit)
    util.appendLists(upgrades, recruit.benefits:shipUpgrades())
  end)
  return upgrades
end
